...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "PTM Ace Design creates a modern, Swiss Style e-commerce landing page for table tennis equipment." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "PTM Ace Design creates a modern, Swiss Style e-commerce landing page for table tennis equipment." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "PTM Ace Design creates a modern, Swiss Style e-commerce landing page for table tennis equipment." },
