...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The PTM menciptakan toko online peralatan tenis meja dengan desain gaya Swiss modern yang premium." },
      { name: "author", content: "The PTM" },
      { property: "og:title", content: "The PTM — Spesialis Tenis Meja Indonesia" },
      { property: "og:description", content: "The PTM menciptakan toko online peralatan tenis meja dengan desain gaya Swiss modern yang premium." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@ThePTM" },
      { name: "twitter:title", content: "The PTM — Spesialis Tenis Meja Indonesia" },
      { name: "twitter:description", content: "The PTM menciptakan toko online peralatan tenis meja dengan desain gaya Swiss modern yang premium." },
